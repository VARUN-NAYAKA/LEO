...
TOOL_DECLARATIONS = [
    ...
    },
    {
        ...
        "description": (
            ...
            "close the assistant, say goodbye, or stop LEO. "
    ...
    },
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "value": {"type": "STRING", "description": "Concise value in English (e.g. Varun, pizza, older sister)"},
            },
...
class LeoLive:
    ...
    async def _listen_audio(self):
        ...
        def callback(indata, frames, time_info, status):
            with self._speaking_lock:
                LEO_speaking = self._is_speaking
            if not LEO_speaking and not self.ui.muted:
                data = indata.tobytes()
